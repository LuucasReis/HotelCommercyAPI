...
namespace MagicVilla_Web.Controllers
{
    public class VillaNumberController : Controller
    {
        ...
        public async Task<IActionResult> CreateVillaNumber(VillaNumberCreateVM villaNumberVM)
        {
            ...
            {
                var response = await _service.CreateAsync<ApiResponse>(villaNumberVM.VillaNumber);
            ...
            var respDropDown = await _villaService.GetAllAsync<ApiResponse>();
        ...
        public async Task<IActionResult> UpdateVillaNumber(VillaNumberUpdateVM villaUpdate)
        {
            ...
            if (ModelState.IsValid)
            {
                var response = await _service.UpdateAsync<ApiResponse>(villaUpdate.VillaNumber);
        ...
        {
            var response = await _service.DeleteAsync<ApiResponse>(villaVM.VillaNumber.VillaNo);
